...
model_folder = "/mnt/lustre/helios-home/morovkat/testing_BiLSTM/models_LSTM2"
model_name = "transform2seq_LSTM_64_dim512"
# model_name = transform2seq_LSTM_em128_dim512
# model_name = transform2seq_LSTM_em64_dim128
# model_name = transform2seq_LSTM_em64_dim64
# model_name = transform2seq_LSTM_em128_dim256
# model_name = transform2seq_LSTM_em32_dim64
# model_name = transform2seq_LSTM_em64_dim256

new = 0

batch_size = 256
epochs = 10
repeat = 5  # full epoch_num=epochs*repeat
...
testing_cache = f"{model_folder}/{model_name}_testingCache.json"
